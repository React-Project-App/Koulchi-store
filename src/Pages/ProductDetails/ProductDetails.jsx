    ...
    <main className="container mt-5 pt-4">
      <div className="row pt-5 ps-4">
        ...
        <div className="col-lg-7 col-sm-12 col-md-6 pt-3 ps-lg-5">
          ...
          <Rating RatingNumber={Reviews} rate="rated"/>
          ...
          <div className="pt-3 ps-1 row">
            <div className="pt-2 ps-1 row col-12 d-flex justify-content-around">
              <div className="quantité col-5  row">
                ...
                <a
                  className=" col-4 text-center fw-bold pointer Amount"
                  onClick={handelDecAmount}
                >
                  -
                </a>
          ...
          <div className="ps-1 pt-3">
            ...
            <p>
              ...
              vestibulum orci a sapien imperdiet maximus. Suspendisse vel ex
              eget mauris efficitur finibus eu a enim. Aenean tellus neque,
              consectetur sit amet lacus a, hendrerit ornare urna. Fusce
              venenatis lorem vitae augue suscipit, eu tempor massa vulputate.
